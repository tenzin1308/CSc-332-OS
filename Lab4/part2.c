...
Author: Tenzin Tashi
Task 4, part 2: Average Grade Calculator
*/
...
int main(int argc, char *argv[])
{
    ...
    scanf("%d", &y);
    const int NUM_ROWS = 10;        // 10 students enrolled in a course
    const int NUM_COLLUMNS = x * y; // each chapter as y number of homeworks
